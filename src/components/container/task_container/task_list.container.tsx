...
const TaskList = observer(() => {
    ...
    return (
        <section className={`min-w-[50%] min-h-[478px] max-h-[478px] overflow-y-auto px-4 py-4 shadow-md overflow-y-auto section-scroll ${treeStore.isDarkTheme ? 'bg-[rgba(15,33,63,0.8)] text-black' : 'bg-[rgba(15,33,63,0.95)] text-gray-200'} rounded-l-lg`}>
